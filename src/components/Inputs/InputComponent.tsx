...
export const InputComponent = ({isPassword, keyboardType, icon, messageRequire, maxLength, value, require, label, onChangeText}: TextInputProps) => {
    ...
    <View>
      <View style={styles.wallpaper}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Icon name={icon} size={scaleSize(20)} color={'#8A9DDD'} />
          <TextInput
